Este curso te proporciona una introducción a la computación en la nube y el uso de software de código abierto para maximizar el desarrollo y las operaciones.
